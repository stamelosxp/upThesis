...
export function renderExpandedTopic(topic, type, userRole) {
    ...
    expandedDiv.dataset.topicId = topic.id;
    ...
    topicTitleLabel.id = 'label-topic-input-title-' + topic.id;
    ...
    descLabel.id = 'label-topic-input-desc-' + topic.id;
    ...
    if (userRole === 'professor') {
        ...
        assignInput.dataset.assignmentId = topic.id;
        ...
        saveBtn.classList.add('accept-button', 'hidden');
